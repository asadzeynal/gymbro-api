...
type Querier interface {
	...
	GetTemplateExercisesByTemplateId(ctx context.Context, templateID uuid.UUID) ([]TemplateExercise, error)
	GetTemplateSetsByTemplateExerciseId(ctx context.Context, templateExerciseID uuid.UUID) ([]TemplateSet, error)
